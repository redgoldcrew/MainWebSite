...
export default function IndruPrivacyPage() {
  useEffect(() => {
    document.title = 'Indru — Privacy Policy';
  }, []);

  return (
    <IndruLayout
      title="Privacy Policy"
      description="This policy explains how Indru handles your information and how we protect your planning experience."
    >
      <section className="rounded-[2rem] border border-white/10 bg-white/5 p-8 shadow-2xl shadow-black/20 backdrop-blur">
        <div className="flex items-center gap-3 text-gold-primary">
          ...
          <p className="text-sm font-semibold uppercase tracking-[0.3em]">Your privacy matters</p>
        </div>
        ...
        <div className="mt-6 space-y-5 text-slate-300">
          ...
          <p>
            We use Your Personal Data to provide and improve the Service. We collect, use, and disclose Your information as described in this Privacy Policy and, where required by applicable law, only where We have a valid legal basis to do so, including Your consent (where consent is required). This Privacy Policy has been created with the help of the <a className="text-gold-primary underline" href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank" rel="noreferrer">Privacy Policy Generator</a>.
          </p>

          <h2 className="mt-8 text-2xl font-semibold text-white">Interpretation and Definitions</h2>
          ...
          <ul className="list-disc space-y-3 pl-6">
            ...
            <li><strong>Application</strong> refers to Indru, the software program provided by the Company.</li>
            <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to Indru.</li>
            <li><strong>Country/State</strong> refers to: Tamil Nadu, India.</li>
          ...
          <h2 className="mt-8 text-2xl font-semibold text-white">Collecting and Using Your Personal Information</h2>
          ...
          <ul className="list-disc space-y-3 pl-6">
            <li><strong>Account Information</strong><ul className="mt-2 list-disc space-y-2 pl-6"><li>User Accounts: retained for the duration of Your Account relationship plus up to 24 months after account closure to handle any post-termination issues or resolve disputes.</li></ul></li>
            <li><strong>Usage Data</strong><ul className="mt-2 list-disc space-y-2 pl-6"><li>Application usage statistics: up to 24 months to understand feature adoption and service improvements.</li><li>Server logs (IP addresses, access times): up to 24 months for security monitoring and troubleshooting purposes.</li></ul></li>
          </ul>
          ...
          <h2 className="mt-8 text-2xl font-semibold text-white">Children's and Minors' Privacy</h2>
          ...
          <h2 className="mt-8 text-2xl font-semibold text-white">Links to Other Websites</h2>
          <p>Our Service may contain links to other websites that are not operated by Us. If You click on a third-party link, You will be directed to that third party's site. We strongly advise You to review the Privacy Policy of every site You visit.</p>
          <p>We have no control over and assume no responsibility for the content, privacy policies or practices of any third-party sites or services.</p>

          <h2 className="mt-8 text-2xl font-semibold text-white">Changes to this Privacy Policy</h2>
          <p>We may update Our Privacy Policy from time to time. We will notify You of any changes by posting the new Privacy Policy on this page.</p>
          <p>We will let You know via email and/or a prominent notice on Our Service, prior to the change becoming effective and update the &quot;Last updated&quot; date at the top of this Privacy Policy.</p>
          <p>You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.</p>

          <h2 className="mt-8 text-2xl font-semibold text-white">Contact Us</h2>
          <p>If You have any questions about this Privacy Policy, You can contact Us:</p>
          <ul className="list-disc space-y-3 pl-6">
            <li>By email: redgoldcrew@gmail.com</li>
            <li>By visiting this page on Our Website: <a className="text-gold-primary underline" href="https://redgoldcrew.in/" target="_blank" rel="noreferrer">https://redgoldcrew.in/</a></li>
            <li>By phone: 09944696125</li>
          </ul>
        </div>
      </section>
    </IndruLayout>
